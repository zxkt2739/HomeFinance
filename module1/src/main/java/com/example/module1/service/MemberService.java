...
public interface MemberService extends BaseService {
    ...
    * 保存一条 Member 数据
    *
    * @param memberDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveMember(MemberDTO memberDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Member 数据
     *
     * @param memberList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveMemberList(List<Member> memberList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Member 数据
     *
     * @param id 数据唯一id
     * @param memberDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateMember(Long id, MemberDTO memberDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateMemberSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteMember(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteMember(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Member
     *
     * @param id 数据唯一id
     * @return 查询到的 Member 数据
     */
     ...
     *
     * @param params 查询条件
     * @return 符合条件的一个 member
     */
    MemberDTO findOneMember(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<MemberDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
