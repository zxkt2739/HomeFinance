...
public interface ExpendService extends BaseService {
    ...
    * 保存一条 Expend 数据
    *
    * @param expendDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveExpend(ExpendDTO expendDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Expend 数据
     *
     * @param expendList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveExpendList(List<Expend> expendList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Expend 数据
     *
     * @param id 数据唯一id
     * @param expendDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateExpend(Long id, ExpendDTO expendDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateExpendSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteExpend(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteExpend(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Expend
     *
     * @param id 数据唯一id
     * @return 查询到的 Expend 数据
     */
    ExpendDTO findExpendById(Long id);

    /**
     * 根据条件查询得到第一条 expend
     *
     * @param params 查询条件
     * @return 符合条件的一个 expend
     */
    ExpendDTO findOneExpend(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<ExpendDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
