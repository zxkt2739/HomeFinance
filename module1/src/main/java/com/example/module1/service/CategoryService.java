...
public interface CategoryService extends BaseService {
    ...
    * 保存一条 Category 数据
    *
    * @param categoryDTO 待保存的数据
    * @param request
    * @throws BizException 保存失败异常
    */
    void saveCategory(CategoryDTO categoryDTO, HttpServletRequest request) throws BizException;

    /**
     * 保存多条 Category 数据
     *
     * @param categoryList 待保存的数据列表
     * @param request
     * @throws BizException 保存失败异常
     */
    void saveCategoryList(List<Category> categoryList, HttpServletRequest request) throws BizException;

    /**
     * 修改一条 Category 数据
     *
     * @param id 数据唯一id
     * @param categoryDTO 待修改的数据
     * @param request
     * @throws BizException 修改失败异常
     */
    void updateCategory(Long id, CategoryDTO categoryDTO, HttpServletRequest request) throws BizException;
     ...
     */
    void updateCategorySelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteCategory(Long id, HttpServletRequest request) throws BizException;
     ...
     */
    void deleteCategory(Long id, HttpServletRequest request) throws BizException;

    /**
     * 根据id查询一条 Category
     *
     * @param id 数据唯一id
     * @return 查询到的 Category 数据
     */
    CategoryDTO findCategoryById(Long id);

    /**
     * 根据条件查询得到第一条 category
     *
     * @param params 查询条件
     * @return 符合条件的一个 category
     */
    CategoryDTO findOneCategory(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合
     */
    List<CategoryDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
